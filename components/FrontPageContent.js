  ...
  return (
    ...
    <section className="p-6 max-w-4xl mx-auto text-center">
      ...
      <p className="mt-4 text-lg">
        I build, deploy and evaluate production-oriented AI systems for public services, with a focus on how they work in practice when the stakes are high. My work includes LLMs and agentic systems used for automation, summarisation and decision support. I am a Principal Data Scientist at Made Tech and a Research Associate at the London School of Economics.
      </p>
      <p className="mt-4">
