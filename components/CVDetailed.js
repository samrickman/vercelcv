    ...
    return (
        <section className="p-6 max-w-4xl mx-auto">
            ...
            <Section title="Selected Research & Reports">
                ...
                <List
                    items={[
                        `Rickman, S. (2025) <a href="https://ascru.nihr.ac.uk/wp-content/uploads/2025/03/rickman-2025-evaluating-gender-bias-cpec-working-paper.pdf" target="_blank">Evaluating Gender Bias in Large Language Models</a> (preprint).`,
                        ...
                        `Rickman, S., Fernandez, J. L., & Malley, J. (2025). <a href="https://doi.org/10.1371/journal.pone.0319745" target="_blank">Understanding patterns of loneliness in older long-term care users using natural language processing with free text case notes.</a> <em>PLOS One</em> ISSN 1932-6203.`,
