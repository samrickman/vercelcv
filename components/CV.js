export default function CV() {
  return (
    ...
    <div className="mt-6">
      ...
      {/* Python */}
      <h4 className="text-lg font-semibold text-gray-300 mt-4">Python</h4>
      ...
      {/* R */}
      <h4 className="text-lg font-semibold text-gray-300 mt-4">R</h4>
      <p className="text-gray-300">
      ...
      <h4 className="text-lg font-semibold text-gray-300 mt-4">Other Tools & Languages</h4>
      <p className="text-gray-300">
      ...
      <div className="mt-6">
        ...
        <h4 className="text-lg font-semibold text-gray-300 mt-4">
